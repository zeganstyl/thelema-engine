...
interface ICamera: ITransformNode {
     ...
     * @return the mutated and unprojected screenCoords [Vec3]
     */
    fun unproject(
        screenCoords: IVec3,
        viewportX: Float = 0f,
     ...
     * @param viewportWidth the width of the viewport in pixels
     * @param viewportHeight the height of the viewport in pixels
     * @return the mutated and projected worldCoords [Vec3]
     */
    fun project(
        worldCoords: IVec3,
        viewportX: Float = 0f,
    ...
    companion object {
        ...
        var Build: () -> ICamera = { Camera() }

        val Default: ICamera = Build().apply {
            name = "Default"
        }
    }
}