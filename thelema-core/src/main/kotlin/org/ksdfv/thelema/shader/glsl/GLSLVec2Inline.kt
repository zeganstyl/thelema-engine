...
/** @author zeganstyl */
class GLSLVec2Inline(var x: Float = 0f, var y: Float = 0f, override var name: String = ""): ShaderData() {
    ...
    override fun asVec3(): String = "vec3($x, $y, 0.0)"
    override fun asVec4(): String = "vec4($x, $y, 0.0, 1.0)"
}