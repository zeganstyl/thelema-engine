...
class Affine2 {
     ...
     * @param mat The source matrix, assumed to be an affine transformation within XY plane. This matrix will not be modified.
     * @return This matrix for the purpose of chaining operations.
     */
    fun set(mat: IMat4): Affine2 {
        val other = mat.values
        m00 = other[IMat4.M00]
        m01 = other[IMat4.M01]
        m02 = other[IMat4.M03]
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToTranslation(trn: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToScaling(scale: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToRotation(radians: Float): Affine2 {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToShearing(shear: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToTRS(x: Float, y: Float, radians: Float, scaleX: Float, scaleY: Float): Affine2 {
        m02 = x
        m12 = y
        if (radians == 0f) {
            m00 = scaleX
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToTRS(trn: Vec2, radians: Float, scale: Vec2): Affine2 {
        return setToTRS(trn.x, trn.y, radians, scale.x, scale.y)
    }
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToTrnRotRadScl(trn: Vec2, radians: Float, scale: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    fun setToTrnScl(trn: Vec2, scale: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun translate(trn: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun preTranslate(trn: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun preScale(scale: Vec2): Affine2 {
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun rotate(radians: Float): Affine2 {
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun preRotate(radians: Float): Affine2 {
        if (radians == 0f) return this
        val cos = MATH.cos(radians)
        val sin = MATH.sin(radians)
     ...
     * @return This matrix for the purpose of chaining.
     */
    fun preShear(shear: Vec2): Affine2 {
