...
class Camera(
    ...
    constructor(position: IVec3, target: IVec3, near: Float = 0.1f, far: Float = 100f): this(near = near, far = far) {
        lookAt(position, target)
        update()
    }

    override val viewMatrix: IMat4 = Mat4().setToLook(position, direction, up)
