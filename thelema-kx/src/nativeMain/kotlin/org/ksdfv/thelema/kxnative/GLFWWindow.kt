...
class GLFWWindow(conf: GLFWWindowConf, sharedContext: CPointer<GLFWwindow>? = null) {
    ...
    companion object {
        ...
        fun setIcon(windowHandle: CPointer<GLFWwindow>?, imagePaths: Array<String>, imageFileLocation: Int) {
        ...
        fun setIcon(windowHandle: CPointer<GLFWwindow>?, images: Array<out IImageData>) {
            memScoped {
