...
class JsonSimpleJson: IJSON {
    override fun parseObject(text: String): IJsonObject =
        JsonSimpleObject(Jsoner.deserialize(text) as JsonObject)

    override fun parseArray(text: String): IJsonArray =
        JsonSimpleArray(Jsoner.deserialize(text) as JsonArray)
    ...
    override fun printObject(json: IJsonObjectIO): String =
        Jsoner.prettyPrint(JsonSimpleObject().apply { json.writeJson(this) }.source.toJson())

    override fun printArray(json: IJsonArrayIO): String =
        Jsoner.prettyPrint(JsonSimpleArray().apply { json.writeJson(this) }.source.toJson())
}