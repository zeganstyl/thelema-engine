...
/** BRDF integration map (lookup texture, LUT)
 *
...
"""
    ...
    fun render(resolution: Int = 512): SimpleFrameBuffer {
        val fb = SimpleFrameBuffer(resolution, resolution, GL_RGB, GL_RGB, GL_UNSIGNED_BYTE, false, false)
        render(fb)
        return fb
    }
}