...
interface IMat4: IJsonObjectIO {
    ...
    override fun writeJson(json: IJsonObject) {
        json["transformDataType"] = transformDataType
        json.setFloats("values", 16) { values[it] }
    }
    ...
    fun mul(other: IMat4, out: IMat4 = this): IMat4 {
        when (transformDataType) {
            ...
            TransformDataType.Translation -> {
                out.m00 = other.m00 + m03 * other.m30
                out.m01 = other.m01 + m03 * other.m31
                out.m02 = other.m02 + m03 * other.m32
                out.m03 = other.m03 + m03 * other.m33
                out.m10 = other.m10 + m13 * other.m30
                out.m11 = other.m11 + m13 * other.m31
                out.m12 = other.m12 + m13 * other.m32
                out.m13 = other.m13 + m13 * other.m33
                out.m20 = other.m20 + m23 * other.m30
                out.m21 = other.m21 + m23 * other.m31
                out.m22 = other.m22 + m23 * other.m32
                out.m23 = other.m23 + m23 * other.m33
                out.m30 = other.m30
                out.m31 = other.m31
                out.m32 = other.m32
                out.m33 = other.m33
    ...
    fun setToProjection(near: Float, far: Float, fovy: Float, aspectRatio: Float): IMat4 {
        val fd = 1f / tan(fovy * (3.1415927f / 180f) / 2f)
    ...
    fun setTransposed3x3From(other: IMat4) {
        m00 = other.m00
        m01 = other.m10
        m02 = other.m20
        m10 = other.m01
    ...
    operator fun timesAssign(other: IMat4) { mul(other) }
 ...
 * @return This vector for chaining
 */
inline fun IMat4.mul(x: Float, y: Float, z: Float, block: (x: Float, y: Float, z: Float) -> Unit) {
    block(
