...
object LOG: ILog {
    ...
    override fun info(message: Any?) = proxy.info(message)

    override fun info(message: Int) = proxy.info(message)

    override fun info(message: Boolean) = proxy.info(message)

    override fun info(message: Float) = proxy.info(message)

    override fun info(message: String, tag: String) = proxy.info(message)
