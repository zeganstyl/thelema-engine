...
public class CachedUrlStream implements PhysicalOggStream {
   ...
   private final RandomAccessFile drain;
   private byte[] memoryCache;
   private final ArrayList<Long> pageOffsets=new ArrayList<>();
   private final ArrayList<Long> pageLengths=new ArrayList<>();
   ...
   */
   ...
   public class LoaderThread implements Runnable {
      ...
      private final RandomAccessFile drain;
      private final byte[] memoryCache;
